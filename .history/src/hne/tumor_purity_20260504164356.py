...
def add_tile_coordinates(scale, 
    ...
    spot_diameter_fullres = scale["spot_diameter_fullres"]
...
def filter_tumor_tiles(tumor_threshold=0.3, # tile at least has 30% tumor purity
